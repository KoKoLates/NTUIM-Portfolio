    ...
    return (
        <div className='navbar-container'>
            <nav>
                ...
                <a href='https://www.behance.net/76b894a4' className='navbar-options'>albums</a>
                <div className='navbar-social-container'>
                    <a href='#cover' className='navbar-options'>socials</a>
                    <div className='navbar-social-dropdown'>
                        <ul>
                            <li style={{ order: 1 }}><a href="https://github.com/KoKoLates" target='_blank' rel='noreferrer'>Facebook</a></li>
                            <li style={{ order: 2 }}><a href="https://github.com/KoKoLates" target='_blank' rel='noreferrer'>Instagram</a></li>
